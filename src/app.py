...
st.write(
    ...
    "In the first part, our focus is primarily on learning how to process large satellite images.\n "
    "In the second part of the lab, we will learn to efficiently train a segmentation model.\n "
    "Next, we will deploy the model in the third part of the lab. \n"
    "In the last part of the lab, we will utilize the deep learning model to perform an impact analysis.\n "
    "This hands-on lab will provide opportunities to get familiar with each step in the development workflow and to enable customizations that are most appropriate for your own use cases. \n"
...
st.page_link("pages/page_1.py", label="User", icon="1️⃣")